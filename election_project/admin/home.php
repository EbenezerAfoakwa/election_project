            ...
            <nav class="navbar navbar-default" role="navigation">
                ...
                <div class="side-menu-container">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="users_db.php"><i class="fa-solid fa-users fa-lg" style="margin-right: 5px;"></i>Users_DB</a></li>
                        <li><a href="forms_db.php"><i class="fa-brands fa-wpforms fa-lg" style="margin-right: 5px;"></i></i>Forms_DB</a></li>
                        <li><a href="signup.php"><i class="fa-brands fa-wpforms fa-lg" style="margin-right: 5px;"></i></i>CreateUser</a></li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </nav>
        </div>
