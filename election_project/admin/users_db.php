  ...
  <body style="width: 98%;">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="../log_in/login.php">Logout</a></li>
              </ul>
            </li>
          </ul>
      ...
      <nav class="navbar navbar-default" role="navigation">
        ...
        <div class="side-menu-container">
          <ul class="nav navbar-nav">
            <li><a href="home.php"><i class="fa-solid fa-window-restore fa-2x" style="margin-right: 3px;"></i></i>Dashboard</a></li>
            <li><a href="users_db.php"><i class="fa-solid fa-users fa-2x" style="margin-right: 5px;"></i>Users_DB</a></li>
            <li><a href="../log_in/login.php"><i class="fa-brands fa-wpforms fa-2x" style="margin-right: 5px;"></i></i>Forms_DB</a></li>
            <li><a href="signup.php"><i class="fa-brands fa-wpforms fa-2x" style="margin-right: 5px;"></i></i>Add User</a></li> 
          </ul>
        </div><!-- /.navbar-collapse -->
      </nav>
    </div>
    ...
    <div class="mcw">
      ...
      <div align="center" style="margin-top: 80px;">
        ...
        <h4 style="font-size: 16px; font-weight:600; ">APPLICATION HISTORY</h4>
      </div>
      <hr>
